...
const Register = () => {
  ...
  <div className="bg-gray-200 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
    ...
    <div className="md:w-1/2 px-8 md:px-16">
      ...
      <input
        ...
        <div className="relative">
          ...
          {/* <svg
            ...
            height={16}
            fill="gray"
            className="bi bi-eye absolute top-5 right-3 -translate-y-1/2"
            viewBox="0 0 16 16"
          >
      ...
      <button onClick={GoogleSignup} className="bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm hover:scale-105 duration-300 text-[#002D74]">
        <svg
          className="mr-3"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 48 48"
